...
{
    /// <summary>
    /// Converts Cell names like AA23 to row/column integers and vica versa
    /// </summary>
    /// 
    /// <remarks>
    /// Thanks to Victor Rodrigues!
    /// https://stackoverflow.com/questions/848147/how-to-convert-excel-sheet-column-names-into-numbers
    /// </remarks>
	public class ExcelCellNamesConverter
	{
        private long   row;
        private long   column;
        ...
        public ExcelCellNamesConverter(long row, long column)
        {
            this.row      = row;
            this.column   = column;
            dataChange    = true;
        ...
        public ExcelCellNamesConverter(string address)
        {
